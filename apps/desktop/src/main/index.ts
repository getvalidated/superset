...
import { applyDisplayP3ColorProfile } from "./lib/color-profile";
...
// Must run before app.whenReady() so Chromium picks up the wide-gamut profile.
applyDisplayP3ColorProfile(app.commandLine);
